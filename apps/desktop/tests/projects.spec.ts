...
test.describe("Projects page", () => {
  ...
  test("shows project cards with health scores", async ({ page }) => {
    await page.goto(BASE, { waitUntil: "networkidle", timeout: 15000 });
    await page.locator("text=Projects").first().click();
    await page.waitForTimeout(1000);
  ...
  test("shows production readiness tab", async ({ page }) => {
    await page.goto(BASE, { waitUntil: "networkidle", timeout: 15000 });
    await page.locator("text=Projects").first().click();
    await page.waitForTimeout(1000);
    await expect(page.locator("text=Project").first()).toBeVisible({ timeout: 5000 });
  ...
  test("checklist shows pass and warn items", async ({ page }) => {
    await page.goto(BASE, { waitUntil: "networkidle", timeout: 15000 });
    await page.locator("text=Projects").first().click();
    await page.waitForTimeout(1000);
    await expect(page.locator("text=Project").first()).toBeVisible({ timeout: 5000 });
  ...
  test("dependencies tab shows packages", async ({ page }) => {
    await page.goto(BASE, { waitUntil: "networkidle", timeout: 15000 });
    await page.locator("text=Projects").first().click();
    await page.waitForTimeout(1000);
    await expect(page.locator("text=Project").first()).toBeVisible({ timeout: 5000 });
  ...
  test("workspaces tab shows monorepo info", async ({ page }) => {
    await page.goto(BASE, { waitUntil: "networkidle", timeout: 15000 });
    await page.locator("text=Projects").first().click();
    await page.waitForTimeout(1000);
    await expect(page.locator("text=Project").first()).toBeVisible({ timeout: 5000 });
  ...
  test("workspace expansion shows checklist and deps", async ({ page }) => {
    await page.goto(BASE, { waitUntil: "networkidle", timeout: 15000 });
    await page.locator("text=Projects").first().click();
    await page.waitForTimeout(1000);
    await expect(page.locator("text=Project").first()).toBeVisible({ timeout: 5000 });
  ...
  test("add project input visible on + click", async ({ page }) => {
    await page.goto(BASE, { waitUntil: "networkidle", timeout: 15000 });
    await page.locator("text=Projects").first().click();
  ...
  test("stats cards show project counts", async ({ page }) => {
    await page.goto(BASE, { waitUntil: "networkidle", timeout: 15000 });
    await page.locator("text=Projects").first().click();
    await page.waitForTimeout(1000);
